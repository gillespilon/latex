...
% the following changes the section name from the default References
...
The definitive book on MSA is by Wheeler \cite{wheeler2006}. The definitive book on SPC is by Wheeler \cite{wheeler2004}. The original article on Taguchi indices was by Russell Boyles \cite{boyles1991}[pages 1-5]. A very good article on the $C_\text{pm}$ index is found in Chen et.al. \cite{chan1988}. Gunter \cite{gunter1989}.
